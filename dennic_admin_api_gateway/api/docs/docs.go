...
const docTemplate = `{
    ...
    "paths": {
        "/v1/admin": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/model_admin_service.GetAdminResp"
                        }
                    },
                    "400": {
            ...
            "put": {
                ...
                "parameters": [
                    {
                        "description": "UpdAdminReq",
                        "name": "UpdAdminReq",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/model_admin_service.UpdAdminReq"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/model_admin_service.UpdAdminResp"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
        ...
        "/v1/admin/create": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "CreateAdminReq",
                        "name": "CreateAdmin",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/model_admin_service.CreateAdminReq"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/model_user_service.EmailRerReq"
                        }
                    }
                ],
                "responses": {
        ...
        "/v1/admin/update-admin-refresh-token": {
            "put": {
                "security": [
                    {
                        "ApiKeyAuth": []
        ...
        "/v1/doctor-working-hours/create": {
            "post": {
                "security": [
                    {
                        "ApiKeyAuth": []
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/model_user_service.User"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        "model_admin_service.CreateAdminReq": {
            "type": "object",
            "properties": {
                "biography": {
                    "type": "string"
        ...
        "model_admin_service.GetAdminResp": {
            "type": "object",
            "properties": {
                "biography": {
                    "type": "string"
        ...
        "model_admin_service.UpdAdminReq": {
            "type": "object",
            "properties": {
                "biography": {
                    "type": "string"
        ...
        "model_admin_service.UpdAdminResp": {
            "type": "object",
            "properties": {
                "biography": {
                    "type": "string"
        ...
        "model_user_service.EmailRerReq": {
            "type": "object",
            "properties": {
                "email": {
                    "type": "string",
