...
// @Accept json
// @Produce json
// @Param search query string false "search" Enums(first_name, last_name,blood_group,phone_number,address,city,country)
...
// @Produce json
// @Param id query string true "id"
// @Param is_active query bool true "is_active"
