...
type Appointment struct {
	...
	UserId               string   `protobuf:"bytes,15,opt,name=user_id,json=userId,proto3" json:"user_id"`
...
func (m *Appointment) GetUserId() string {
	if m != nil {
		return m.UserId
	}
	return ""
...
type CreateAppointmentReq struct {
	...
	UserId               string   `protobuf:"bytes,14,opt,name=user_id,json=userId,proto3" json:"user_id"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (m *CreateAppointmentReq) GetUserId() string {
	if m != nil {
		return m.UserId
	}
	return ""
...
type UpdateAppointmentReq struct {
	...
	UserId               string   `protobuf:"bytes,16,opt,name=user_id,json=userId,proto3" json:"user_id"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (m *UpdateAppointmentReq) GetUserId() string {
	if m != nil {
		return m.UserId
	}
	return ""
...
var fileDescriptor_8ede99e18a76dc86 = []byte{
	...
	,
}
...
func (m *Appointment) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.UserId) > 0 {
		...
		i = encodeVarintBookedAppointments(dAtA, i, uint64(len(m.UserId)))
		i--
		dAtA[i] = 0x7a
	}
